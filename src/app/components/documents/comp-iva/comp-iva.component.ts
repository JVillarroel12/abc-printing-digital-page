...
@Component({
  selector: 'app-comp-iva',
  templateUrl: './comp-iva.component.html',
  styleUrls: ['./comp-iva.component.scss'],
})
export class CompIvaComponent implements OnInit {
  headerSelected = {
    id: '05',
    name: 'COMP. RETENCION - IVA',
  };
  ...
  async getAllDocument() {
    ...
    query.subscribe(
      (data: any) => {
        ...
        console.log('RESP =>', this.allDocuments);
