...
@Component({
  selector: 'app-comp-islr',
  templateUrl: './comp-islr.component.html',
  styleUrls: ['./comp-islr.component.scss'],
})
export class CompIslrComponent implements OnInit {
  headerSelected = {
    id: '06',
    name: 'COMP RETENCION - ISLR',
  };
