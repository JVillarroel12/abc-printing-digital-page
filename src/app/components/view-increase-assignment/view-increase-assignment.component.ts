...
import { IncreaseAssignmentPage } from 'src/app/modals/increase-assignment/increase-assignment.page';
...
@Component({
  selector: 'app-view-increase-assignment',
  templateUrl: './view-increase-assignment.component.html',
  styleUrls: ['./view-increase-assignment.component.scss'],
})
export class ViewIncreaseAssignmentComponent implements OnInit {
  form = {
    name: '',
    fechaInicio: '',
    fechaFin: '',
