...
@Component({
  selector: 'app-view-rep-sales-book',
  templateUrl: './view-rep-sales-book.component.html',
  styleUrls: ['./view-rep-sales-book.component.scss'],
})
export class ViewRepSalesBookComponent implements OnInit {
  form = {
    type: '',
    fechaInicio: '',
    fechaFin: '',
